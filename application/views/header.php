      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul class="navbar-nav ">
			...
			<li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('stock/merchant_account_add')?>">Merchant Account</a>
            </li>
			<li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('stock/merchantaccount')?>">Merchant Account list</a>
            </li>
			<li class="nav-item">
